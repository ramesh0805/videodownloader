from tkinter import *            # for Building Python GUI Application
from PIL import Image, ImageTk    # for image displaying and resizing
from pytube import YouTube
import instaloader               # for downloading Instagram videos
...
class Downloader:
    ...
    def youtube(self):
        try:
            ...
            self.save = self.yt.streams.get_highest_resolution()
